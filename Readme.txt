...
# `src/main/java/com/NotifEaze/NotifEaze/controller`: Contains a sample controller for testing the services. (To be created)
    Create API's to send sms/email/PushNotification

# Since we are integrating multiple vendors for sms/email/pn there should be some configuration which will decide which vendor to route to